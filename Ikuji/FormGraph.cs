    ...
    public partial class FormGraph : Form
    {
        ...
        private void cmbGraphChange_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if(cmbGraphChange.SelectedIndex == 1)
            {
                ...
                //X軸のカスタマイズ
                Axis axisX = grfHistory.ChartAreas[0].AxisX;
                ...
                //Y軸のカスタマイズ
                Axis axisY = grfHistory.ChartAreas[0].AxisY;
            ...
            if(cmbGraphChange.SelectedIndex == 2)            
            {
                ...
                // データ追加
                var hist = new Point[] {
                new Point((int)DateTime.Now.AddDays(0).ToOADate(), 5),
                new Point((int)DateTime.Now.AddDays(1).ToOADate(), 2),
                new Point((int)DateTime.Now.AddDays(2).ToOADate(), 7),
                new Point((int)DateTime.Now.AddDays(3).ToOADate(), 8),
                new Point((int)DateTime.Now.AddDays(4).ToOADate(), 1),
                new Point((int)DateTime.Now.AddDays(5).ToOADate(), 2),
                new Point((int)DateTime.Now.AddDays(6).ToOADate(), 4),
                new Point((int)DateTime.Now.AddDays(7).ToOADate(), 3),
                new Point((int)DateTime.Now.AddDays(8).ToOADate(), 5),
                };
